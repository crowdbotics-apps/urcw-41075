"""
Django settings for urcw_41075 project.
...
WSGI_APPLICATION = 'urcw_41075.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "urcw_41075 API",
    "DESCRIPTION": "API documentation for urcw_41075 App",
    "VERSION": "v1",
}
